      ...
      imgs: [
        {
          ...
          author: "LLXiao",
          desc: "暖通机房工程——从实地测绘到生产出图的完整交付"
        },
        {
          src: "https://img.xiliab.online/uploads/JX_egg.jpg",
          author: "LLXiao",
          desc: "自动化养殖设备——数据驱动的设计迭代与制造落地"
        },
      ],
    },
    {
      ...
      imgs: [
        {
          ...
          author: "LLXiao",
          desc: "<strong>转行 · 从机械到体验</strong><br/><span style='opacity:0.7;'>用体验连接人和技术，让复杂变得自然。</span>"
        },
        {
          type: "video",
...
通过优化信息架构与任务路径，大幅降低了设计工具的使用门槛，让用户更关注创意本身而非工具操作。`,
    ...
    },
    {
      ...
      company: "银光科技公司",
      de: "广州",
      more: "面向企业的全渠道在线客服与客户关系管理系统，帮助企业高效整合多平台客户沟通与运营。<br/><br/>核心能力：<br/>• 全平台统一客服接入，PC / 移动端全覆盖。<br/>• 客户标签画像与精准营销，支持自动化分层运营。<br/>• 智能回复与数据分析，全链路跟踪客服绩效。<br/><br/>从获客、沟通到成交的完整路径梳理，帮助企业在每一个触点上优化客户体验。",
      imgs: [
        {
    ...
    },
    {
      ...
      company: "银光科技公司",
      de: "广州",
      more: "面向私域电商的社交客户关系管理系统，整合多平台数据，支持自动化运营与企业微信侧边栏客户资料实时展示。<br/><br/>核心能力：<br/>• 统一管理微信、抖音等多平台客户资源，全流程跟进闭环。<br/>• 自动化营销引擎联动订单与云仓，高效驱动转化。<br/>• 企业微信侧边栏实时呈现客户画像，赋能精准服务决策。",
      imgs: [
        {
    ...
    },
    {
      ...
      company: "银光科技公司",
      de: "广州",
      more: "面向私域场景的内容运营工具，通过自动邀约、行为追踪与数据分析，提升客户激活与转化效率。<br/><br/>核心能力：<br/>• 渠道定向推送：根据客户来源自动发送绑定链接与个性化欢迎语。<br/>• 行为智能追踪：记录观看与互动行为，自动打标签实现精准触达。<br/>• 企业微信侧边栏实时客户数据展示，辅助高效跟进与转化。<br/><br/>成果：视频观看完整率提升 21%，成交转化率提升 10%，员工工作量降低 38%。",
      imgs: [
        {
