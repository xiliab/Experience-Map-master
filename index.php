...
if ($lang == "cn") {
  $extraHead = "";
  // $pageDesc="可交互的LLXiao体验地图，展示了他的工作经历和设计项目";
  // $pageLang="zh-Hans";
  $jsLang = "cn";
} else {
  $extraHead = "";
  // $pageDesc="An interactive experience map of LLXiao";
  // $pageLang="en-US";
  $jsLang = "en";
}
...
echo
<<<HTML
<html lang="<?php echo $lang == 'cn' ? 'zh-Hans' : 'en'; ?>">
	<head>
      <style>
    .bridge-name,
    .section-name {
  ...
  [v-cloak],.hidden-area{display: none;}
    ...
    <meta charset="UTF-8">
    <title>LLXiao的体验地图 LLXiao's Experience Map</title>
    <meta name="robots" content="noodp"/>
    <meta name="author" content="LLXiao" />
    <meta name="description" content="可交互的LLXiao体验地图，展示了他的工作经历和设计项目 An interactive experience map of LLXiao"/>
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=5.0" />
    <meta name="format-detection" content="telephone=no">

    <meta property="og:url" content="https://">
    <meta property="og:type" content="website">
    <meta property="og:title" content="LLXiao的体验地图">
    <meta property="og:description" content="可交互的LLXiao体验地图，展示了他的工作经历和设计项目">
    <meta property="og:image" content="https://cdn.jsdelivr.net/gh/xiliab/my-images@main/screenshot_0.5x.jpg">

    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="LLXiao的体验地图" />
    <meta name="twitter:description" content="可交互的LLXiao体验地图，展示了他的工作经历和设计项目" />
    <meta name="twitter:site" content="@xiliab" />
    <meta name="twitter:image" content="https://cdn.jsdelivr.net/gh/xiliab/my-images@main/screenshot_0.5x.jpg" />
...
<div id="app" :class="[showAllCornerNames ? 'show-all-corners' : '', lang ]">
      ...
      <div class="mid " v-cloak>
        ...
        <div class="msg" v-if="p == 0">
          <div class="inner" v-if="p == 0" v-cloak>
            <p class="title-font msg-title" v-if="lang == 'cn'">LLXiao的体验地图</p>
            <p class="title-font msg-title" v-if="lang == 'en'">LLXiao's Experience Map</p>
            <p v-if="lang == 'cn'">LLXiao（职业：用户体验设计师）出生于 1988 年，专注于多端平台的用户体验设计与优化。具备从用户研究、需求分析到交互设计、产品落地的完整经验，尤其擅长B端复杂系统设计与交互优化，致力于通过设计创新提升产品的商业价值和用户体验。</p>
            <p v-if="lang == 'en'">Born in the 1980s, LLXiao is a UX designer for multi-platform B2B systems, leveraging full-cycle expertise to boost business value and user satisfaction.</p>
            <div class="indicator">
              <div v-if="lang == 'cn'">向下滚动开始体验</div>
              <div v-if="lang == 'en'">Scroll to start</div>
  ...
  <div class="desc skew-p">
    <div class="logo">
      <div class="inner skew-n">
        <span class="title-font" v-if="lang == 'cn'">L<span></span>LXiao<span></span>的体验地图</span>
        <span class="title-font" v-if="lang == 'en'">LLXiao's Experience Map</span>
      ...
      <div class="inner desc-msg" v-if="p == 1" v-cloak>
        <div class="ending skew-n" v-if="p > 0.999">
          ...
          <div class='btn skew-p' @click="setP(0.001)">
            <div class='skew-n title-font' v-if="lang == 'cn'">重新体验</div>
            <div class='skew-n' v-if="lang == 'en'">Try Again</div>
          </div>
        </div>
      </div>
  ...
  <div class="thumb" v-for="img in currentCorner.imgs" :class="img.url ? 'has-author' : '' ">
    ...
    <img
      ...
      loading="lazy"
      style="height: 100%; width: 100%; object-fit: contain; display: block; cursor: pointer;"
      @click="openModal('image', img)"
    />
    <!-- 视频缩略图 -->
    <div v-else-if="img.type === 'video'" style="position: relative; height: 100%; width: 100%;">
      <img
        class="skew-n"
        :src="img.thumb || 'https://cdn.jsdelivr.net/gh/xiliab/my-images@main/video_default_thumb.jpg'"
        loading="lazy"
        style="height: 100%; width: 100%; object-fit: contain; display: block; filter: brightness(.8); cursor: pointer;"
        @click="openModal('video', img)"
      />
      <!-- 视频icon右下角小图标 -->
      <span style="position: absolute; bottom: 8px; right: 8px; color: white; background: rgba(0,0,0,0.6); border-radius: 4px; font-size: 18px; padding: 2px 6px;">▶</span>
    </div>
    <a class="thumb-source" v-if="img.url" :href="img.url" target="_blank" title="查看照片来源">
    ...
    <div class="controls">
      ...
      <div class="inner skew-n">
        ...
        <div class="toggle-group" :class=" showAllCornerNames ? 'on' : 'off' " @click="showAllCornerNames = !showAllCornerNames">
          <span v-if="lang == 'cn'">所有工作</span>
          <span v-if="lang == 'en'">All Works</span>
